...
def main(dataset_dir):
    ...
    out_3['test_filenames'] = test_list_3
    out_3['val_filenames'] = test_list_3
    ...
    out_5['test_filenames'] = test_list_5
    out_5['val_filenames'] = test_list_5
    ...
    out_15['test_filenames'] = test_list_15
    out_15['val_filenames'] = test_list_15
    ...
    out_20['test_filenames'] = test_list_20
    out_20['val_filenames'] = test_list_20
    ...
    out_10['test_filenames'] = test_list_10
    out_10['val_filenames'] = test_list_10
    ...
    out_25['test_filenames'] = test_list_25
    out_25['val_filenames'] = test_list_25
    ...
    out_50['test_filenames'] = test_list_50
    out_50['val_filenames'] = test_list_50
    ...
    out_75['test_filenames'] = test_list_75
    out_75['val_filenames'] = test_list_75
    ...
    out_100['test_filenames'] = test_list_100
    out_100['val_filenames'] = test_list_100
    ...
    out_150['test_filenames'] = test_list_150
    out_150['val_filenames'] = test_list_150
    ...
    out_300['test_filenames'] = test_list_300
    out_300['val_filenames'] = test_list_300
    ...
    out_all['test_filenames'] = test_list_all
    out_all['val_filenames'] = test_list_all
